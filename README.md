...
jobs:
  claude-response:
    ...
    steps:
      - uses: satoshi-jp/claude-code-action@beta  # Fork with OAuth support
        with:
...
This action is built on top of [`satoshi-jp/claude-code-base-action`](https://github.com/satoshi-jp/claude-code-base-action).
