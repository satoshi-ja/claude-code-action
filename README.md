...
jobs:
  claude-response:
    ...
    steps:
      - uses: satoshi-ja/claude-code-action@main # Fork with OAuth support
        with:
...
This action is built on top of [`satoshi-ja/claude-code-base-action`](https://github.com/satoshi-ja/claude-code-base-action).
